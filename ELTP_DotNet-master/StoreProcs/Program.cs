...
try
{
    ...
    Cmd.CommandText = "sp_insertEmpSkill";

    // Now using the Parameters
    SqlParameter pProjectid = new SqlParameter();
    pProjectid.ParameterName = "@ProjectId";
    pProjectid.DbType = System.Data.DbType.Int32;
    pProjectid.Direction = System.Data.ParameterDirection.Input; // DEfault is Input
    pProjectid.Value = 10;
    ...
    pSkills.Direction = System.Data.ParameterDirection.Input; // DEfault is Input
    pSkills.Size = 100;
    pSkills.Value = "Tester_QA";
    Cmd.Parameters.Add(pSkills);

    SqlParameter pExperience = new SqlParameter();
    pExperience.DbType = System.Data.DbType.String;
    pExperience.Direction = System.Data.ParameterDirection.Input; // DEfault is Input
    pExperience.Size = 100;
    pExperience.Value = "10 years";
